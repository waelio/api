import { d as defineEventHandler, h as handleCors, g as getQuery } from '../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const gnames = [
	...
	{
		name: "الرَّحْمَنُ",
		text: "الرحمن معناه الكثرة، يعني اسم الله الرحمن يشمل كل الخلائق من دون استثناء، فرحمته وسعت كل شيء، وهو أرحم الراحمين"
	},
	{
		name: "الْمُنْتَقِمُ",
...
const holynames = defineEventHandler((event) => {
  var _a;
  if (handleCors(event, { origin: "*" })) {
    return;
  }
  const query = getQuery(event);
  const name = (_a = query.name) == null ? void 0 : _a.toString();
  if (name) {
...
export { holynames as default };
//# sourceMappingURL=holynames.mjs.map
